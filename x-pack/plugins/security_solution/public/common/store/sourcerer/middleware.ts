    ...
    return async (action: Action) => {
      ...
      if (action.type === sourcererActions.appInitialized.type) {
        ...
        try {
          ...
          const tes = sourcererDataViews.kibanaDataViews.map((dataView: KibanaDataView) => ({
            ...initDataView,
            ...dataView,
          }));
