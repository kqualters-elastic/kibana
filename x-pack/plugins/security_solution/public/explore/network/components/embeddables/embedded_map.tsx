...
import { kv, sdefaultDataView } from '../../../../common/store/sourcerer/selectors';
...
export const EmbeddedMapComponent = ({
  ...
  const kibanaDataViews = useSelector(kv);
  const { selectedPatterns } = useSelector(sdefaultDataView);
